...
import secrets
from models import prediction_result  # Import the function from model.py
...
def input_data():
    if request.method == 'POST':
        try:
            ...
            # Make a prediction using the prediction_result function
            features = [
            ...
            predicted_result = prediction_result(features)
